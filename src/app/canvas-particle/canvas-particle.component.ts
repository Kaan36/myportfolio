...
@Component({
  selector: 'app-canvas-particle',
  templateUrl: './canvas-particle.component.html',
  styleUrls: ['./canvas-particle.component.scss']
})
export class CanvasParticleComponent implements OnInit, AfterViewInit {
