...
@Component({
  selector: 'app-calculator-js',
  templateUrl: './calculator-js.component.html',
  styleUrls: ['./calculator-js.component.scss']
})
export class CalculatorJsComponent implements OnInit, AfterViewInit {
