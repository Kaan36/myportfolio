...
@Component({
  selector: 'app-canvas-stroke',
  templateUrl: './canvas-stroke.component.html',
  styleUrls: ['./canvas-stroke.component.scss']
})
export class CanvasStrokeComponent implements OnInit, AfterViewInit {
